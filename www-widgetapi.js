...
function Wa(a,b){var c=m("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflUJbESo/yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=[],c="ERRORS"in M?M.ERRORS:c,c.push([a,b,void 0,void 0,void 0]),Ua("ERRORS",c))}
...
f.O=function(a){W(this,"setVideoTitle",arguments)};t("YT.PlayerState.UNSTARTED",-1);t("YT.PlayerState.ENDED",0);t("YT.PlayerState.PLAYING",1);t("YT.PlayerState.PAUSED",2);t("YT.PlayerState.BUFFERING",3);t("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflUJbESo/YT.PlayerState.CUED",5);t("YT.UploadWidgetEvent.API_READY","onApiReady");t("YT.UploadWidgetEvent.UPLOAD_SUCCESS","onUploadSuccess");t("YT.UploadWidgetEvent.PROCESSING_COMPLETE","onProcessingComplete");t("YT.UploadWidgetEvent.STATE_CHANGE","onStateChange");t("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflUJbESo/YT.UploadWidgetState.IDLE",0);t("YT.UploadWidgetState.PENDING",1);
t("YT.UploadWidgetState.ERROR",2);t("YT.UploadWidgetState.PLAYBACK",3);t("YT.UploadWidgetState.RECORDING",4);t("YT.UploadWidgetState.STOPPED",5);t("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflUJbESo/YT.get",function(a){return O[a]});
t("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflUJbESo/YT.scan",gb);t("YT.subscribe",function(a,b,c){J.subscribe(a,b,c);fb[a]=!0;for(var d in O)lb(O[d],a)});
